...
/** @type {string} */
const CACHE_VERSION = '1746625642|262635800';
/** @type {string} */
const CACHE_PREFIX = 'RiposteGit-sw-cache-';
...
/** @type {string[]} */
const CACHED_FILES = ["post-apocalyptic-survival.html","post-apocalyptic-survival.js","post-apocalyptic-survival.offline.html","post-apocalyptic-survival.icon.png","post-apocalyptic-survival.apple-touch-icon.png","post-apocalyptic-survival.audio.worklet.js","post-apocalyptic-survival.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["post-apocalyptic-survival.wasm","post-apocalyptic-survival.pck"];
